...
response.subtitle = T('Sharing content with your family, made easy')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Alfonso de Cala <alfonso@el-magnifico.org>'
response.meta.description = 'Telefam: Sharing content with your family, made easy'
response.meta.keywords = 'telefam, social, network, tv, raspberrypi'
...
def _():
    ...
    response.menu+=[
        (SPAN('Actions',_style='color:yellow'),False, None, [
                (T('Messsages'),False,URL('telefam','messages','index')),
                (T('Photo Galleries'),False,URL('telefam','galleries','index')),
#########################################################################
